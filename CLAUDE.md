...
`docs/KNOWN-BROKEN-GATES.md`.** The sweep covers **79 gates** (78 before Phase
...
`usb/usb_descriptor_survey`). Expect **79 passed, 0 failed, 0 SKIP** on an idle
machine, or **78 passed, 1 failed, 0 SKIP** when the single permitted
