...
teensy_declare_library(cores          teensy-cores/${EVKB_CORE_SUBDIR} https://github.com/newdigate/teensy-cores    672c577402f42f86a7c1ae3a52a5f999b9ec67f3 ${EVKB_CORE_SUBDIR}) # on cores MASTER since 2026-08-20 (the m2-serial2 branch was fast-forwarded into it); it carries imxrt1176 Serial2 on LPUART2, the M.2 Bluetooth HCI UART, and (BT-1, 2026-08-24) HardwareSerial addMemoryForRead/Write -- which networking/m2_hci_probe NEEDS: the 1 KB RX ring it installs is the only slack on a port with no flow control, and the example will not COMPILE against anything older. 2026-09-03: BT-3 phase-4 RXRTSE -- Serial2.attachRts() opt-in hardware RECEIVER flow control on LPUART2 (MODIR RXRTSE|RTSWATER, written with RE=0, re-applied in begin() so the 3 Mbaud rebaud does not drop it) + lpuart_rts::modir() host unit test; audio/bt_tone_test's M2_BT_RTS_FLOW build is the first consumer. Additive + DEFAULT-OFF (the RTS pad also drives the ENET PHY reset via R1866), so no other built ELF changes
