...
macro(import_evkb_cmsis_dsp)
    if(NOT TARGET CMSIS-DSP)
        ...
        # Include-order armor: a generated wrapper shadows <arm_math.h> so a TU
        # may include Arduino.h and arm_math.h in either order. It papers over
        # two core-vs-CMSIS clashes: (1) pins_arduino.h's "#define A0 16" (and
        # A1/A2) vs the A0/A1/A2 struct members in dsp/controller_functions.h;
        # (2) core_pins.h's __disable_irq()/__enable_irq() static inlines vs
        # the identical definitions in CMSIS-Core's cmsis_gcc.h (renamed away —
        # nothing in the DSP code calls them after the parse).
        file(CONFIGURE OUTPUT "${CMAKE_BINARY_DIR}/evkb-cmsis-shim/arm_math.h"
             CONTENT [[
/* Generated by evkb.cmake (import_evkb_cmsis_dsp) - do not edit. */
...
#include "@_evkb_cmsisdsp_dir@/Include/arm_math.h"
#undef __disable_irq
#undef __enable_irq
#pragma pop_macro("A2")
#pragma pop_macro("A1")
#pragma pop_macro("A0")
        ...
        target_include_directories(CMSIS-DSP
            PUBLIC  "${CMAKE_BINARY_DIR}/evkb-cmsis-shim"
