...
| Folder | Examples |
|--------|----------|
| **dualcore** | `cm4_boot_test`, `cm4_dual_test`, `cm4_image_test`, `cm4_intr_test`, `cm4_spi_test`, `cm4_wire_test`, `cm4_wire_int_master_test`, `cm4_wire_int_slave_test`, `cm4_spi_dma_test`, `cm4_wire_dma_test`, `cm4_hotswap_test`, `cm4_hotswap2_test`, `cm4_imagebank_test`, `cm4_sai_irq_probe`, `cm4_cpp_test`, `cm4_audiostream_test`, `dualcore_mu_test` |
...
| **audio** | `audioinput_i2s_test`, `audiooutput_i2s_test`, `audiostream_test`, `filter_fir_test`, `guard_sweep_test`, `i2s_audio_test`, `sai_rx_test`, `sd_wav_play_test`, `tone_test`, `tone_hw` |
