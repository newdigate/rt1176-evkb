...
extern "C" void tcpecho_raw_init(void);   /* tcpecho_raw.c (compiled as C); no extern "C" guard in its .h */
...
void setup() {
    ...
    tcpecho_raw_init();     /* raw-API TCP echo server */
