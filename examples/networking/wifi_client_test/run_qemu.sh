...
# cannot tell them apart: run the SAME elf with `-machine
# mimxrt1170-evk,m2-wifi=on` (no fw-preboot) and it still prints 255, from the
# "no firmware, none supplied" branch -- measured, not assumed.  What IS
# asserted is the clean-failure contract on whichever branch fires.
